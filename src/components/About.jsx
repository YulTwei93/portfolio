...
export default function About() {
  return (
    <section id="ueber-mich" className="relative py-24">
...
>
  <div>
    ...
    <h2 className="text-4xl font-bold font-display md:text-5xl text-text-primary">
      Über <span className="text-gradient">mich</span>
    </h2>
  </div>

  
    <a href="/lebenslauf_yuliya-tweitmann.pdf"
    download
